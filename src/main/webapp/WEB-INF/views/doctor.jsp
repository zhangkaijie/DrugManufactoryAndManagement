  ...
  <div class="container">
    <div class="navbar navbar-inverse navbar-static-top">
      ...
      <a class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
        ...
        <a class="navbar-brand" href="#">Welcome <c:if test="${!empty sessionScope.doctor.username}">${sessionScope.doctor.username}</c:if></a>
        </div>
                       ...
                       <li><a href="#footer"></a></li>
                        <li><a href="#footer"></a></li>
                         <li><a href="#footer"></a></li>
                          ...
                          <li><a href="#footer"></a></li>
                           <li><a href="#footer"></a></li>
                            <li><a ><c:if test="${!empty sessionScope.doctor.username}">${sessionScope.doctor.username}</c:if></a></li>
...
<div class="container marketing">
    <div align="center">
       <header> <h1>The Doctor Work Area </h1></header>
    </div>
  <!-- Three columns of text below the carousel -->
  <div class="row" align="center">
     <div class="col-md-4 text-center" >
      <img class="img-circle" src="http://medisolv.com/wp-content/uploads/Electronic-Sumbission-Doctor-140x140.jpg">
      <h2><a href="viewPatient.htm">View Patient's Request </a></h2>
      
    </div>

   <div class="col-md-4 text-center" >
      <img class="img-circle" src="http://www.conceptionadvice.com/wp-content/uploads/2016/05/Doctor-with-Clipboard.jpg">
      <h2><a href="patientRequestHistory.htm">Request History</a></h2>
         
    </div>

    <div class="col-md-4 text-center" >
      <img class="img-circle" src="http://indepthnh.org/wp-content/uploads/2016/08/drugdoc-140x140.jpg">
      <h2><a href="connectScientist.htm">Send Data To Scientist</a></h2>
