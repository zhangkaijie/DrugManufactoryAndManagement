  ...
  <div class="container">
    <div class="navbar navbar-inverse navbar-static-top">
      ...
      <a class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
        ...
        <a class="navbar-brand" href="#">Welcome <c:if test="${!empty sessionScope.compoundManufactor.username}">${sessionScope.compoundManufactor.username}</c:if></a>
        </div>
                       ...
                       <li><a href="#footer"></a></li>
                        <li><a href="#footer"></a></li>
                         <li><a href="#footer"></a></li>
                          ...
                          <li><a href="#footer"></a></li>
                           <li><a href="#footer"></a></li>
                            <li><a ><c:if test="${!empty sessionScope.compoundManufactor.username}">${sessionScope.compoundManufactor.username}</c:if></a></li>
...
<div align="center">
<h1 align="center">Information From DrugManufactor</h1>
 <br></br>
 <c:if test="${empty list2}"><h2>No new Information !</h2>
 <br>
 <button><a href="CompoundManufactorHome.htm">Go To Main Page</a></button>
 </c:if>
 <c:if test="${!empty list2}">
 <form action="changeStatus2.htm" method="post">
<table border>
    <thead>
    <tr>
        <th>Compound</th>
    ...
    <tbody>
    <c:if test="${!empty list2}">
    <c:forEach var="item" items="${list2}" varStatus="i">
        <tr>
            <td><input name="compound" value="${item.compound}"></td>
            <td><input name="message" value="${item.message}" style="width:300px"></td>
        </tr>
    </c:forEach>
    </c:if>
    </tbody>
