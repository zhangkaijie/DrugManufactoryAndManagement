...
<div align="center">
<h1 align="center">Health Data</h1>
<br></br>
 <c:if test="${empty list}"> <h2>Sorry, we do not have data for this disease </h2>
 <br></br>
 <button><a href="ScientistHome.htm">Go To Main Page</a></button>
 </c:if>
 <c:if test="${!empty list}">
<form action="research.htm" method="post">
<table border>
    <thead>
    <tr>
        <th>Disease </th>
    ...
    <c:forEach var="item" items="${list}" varStatus="i">
        <tr>
            <td><input name="disease" value="${item.disease}"></td>
            <td><input name="drug" value="${item.drug}"></td>
            <td><input name="gene" value="${item.gene}"></td>
            <td><input name="compound1" value="${item.compound1}"></td>
            <td><input name="compound2" value="${item.compound2}"></td> 
            <td><input name="compound3" value="${item.compound3}"></td>    
        </tr>
    </c:forEach>
    </c:if>
    </tbody>
...
<br></br>
<input type="submit" value="Analysis Data">
</form>
</c:if>
</div>
<br></br>
