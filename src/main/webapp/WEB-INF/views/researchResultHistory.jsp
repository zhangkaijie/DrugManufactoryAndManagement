...
<div align="center">
<h1 align="center">Research Result History</h1>
 <br></br>
 <c:if test="${empty list2}"><h3>No Research Result History Records !</h3>
 <br>
 <button><a href="DrugManufactorHome.htm">Go To Main Page</a></button>
 </c:if>
...
<table border>
    ...
    <c:forEach var="item" items="${list2}" varStatus="i">
        <tr>
            <td><input style="width:400px;" name="result" value="${item.result}"></td>
