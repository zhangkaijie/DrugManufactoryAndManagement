...
<form:form action="connectScientist.htm" commandName="doctorScientistInteraction"
    method="post">
 ...
 <table>
      ...
      <tr style="height:50px">
        ...
        <td><form:input name="disease" path="disease" size="30" placeholder="Disease" style="height:30px; border-radius:5px" required="required" />
          <font color="red"><form:errors path="disease" /></font></td>
      </tr>
       
      <tr style="height:50px">
        
        <td><form:input name="drug" path="drug" size="30" placeholder="Drug" style="height:30px; border-radius:5px" required="required" />
          <font color="red"><form:errors path="drug" /></font></td>
      </tr>
            
      <tr style="height:50px">
        <td id="td" colspan="2"><input id="submit" type="submit" value="Send To Scientist" /></td>
      </tr>
    </table>
