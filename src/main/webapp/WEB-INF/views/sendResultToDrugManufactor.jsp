...
<form:form action="connectDrugManufactor.htm" commandName="drugManufactorScientistInteraction"
    method="post">
 ...
 <table>
      ...
      <tr style="height:50px">
        ...
        <td><form:input name="result" path="result" size="30" placeholder="Result" style="height:30px; border-radius:5px" required="required" />
          <font color="red"><form:errors path="result" /></font></td>
      </tr>
       
            
      <tr style="height:50px">
        <td id="td" colspan="2"><input id="submit" type="submit" value="Send To DrugManufactor" /></td>
      </tr>
    </table>
