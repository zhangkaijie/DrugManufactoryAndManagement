...
<head>
    ...
    <title>home page  - Bootsnipp.com</title>
  ...
  <div class="container">
    <div class="navbar navbar-inverse navbar-static-top">
      ...
      <a class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
        ...
        <a class="navbar-brand" href="#">Welcome <c:if test="${!empty sessionScope.scientist.username}">${sessionScope.scientist.username}</c:if></a>
        </div>
                       ...
                       <li><a href="#footer"></a></li>
                        <li><a href="#footer"></a></li>
                         <li><a href="#footer"></a></li>
                          ...
                          <li><a href="#footer"></a></li>
                           <li><a href="#footer"></a></li>
                            <li><a ><c:if test="${!empty sessionScope.scientist.username}">${sessionScope.scientist.username}</c:if></a></li>
...
<div class="container marketing">
    <div align="center">
       <header> <h1>The Scientist Work Area </h1></header>
    </div>
  <!-- Three columns of text below the carousel -->
  <div class="row" align="center">
     <div class="col-md-4 text-center" >
      <img class="img-circle" src="https://www.brighton.ac.uk/images/course-images/course-thumbnails/biomedical-science-cropped-140x140.jpg">
      <h2><a href="analysisByDisease.htm">Analysis Health Data </a></h2>
      
    </div>

   <div class="col-md-4 text-center" >
      <img class="img-circle" src="https://nonprofitquarterly.org/wp-content/blogs.dir/56/files/2015/03/HIV-drug-140x140.jpg">
      <h2><a href="analysisHistory.htm">Analysis History</a></h2>
         
    </div>

    <div class="col-md-4 text-center" >
      <img class="img-circle" src="https://crunchbase-production-res.cloudinary.com/image/upload/c_pad,h_140,w_140/v1423295675/j2lm0b8nymuionuz66od.png">
      <h2><a href="connectDrugManufactor.htm">Send Result To DrugManufactor</a></h2>
