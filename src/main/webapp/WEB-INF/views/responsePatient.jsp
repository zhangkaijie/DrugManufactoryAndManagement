...
<div align="center">
<h1 align="center">Patients Information</h1>
<c:if test="${empty list}"><h2>No new patients requests !</h2>
<br>
<button><a href="DoctorHome.htm">Go To Main Page</a></button>
</c:if>
<br></br>
 <c:if test="${!empty list}">
<form action="responsePatient.htm" method="post">
<table border>
    <thead>
    <tr>
    ...
    <c:forEach var="item" items="${list}" varStatus="i">
        <tr>
            <td><input name="description" value="${item.diseaseDescription}"></td>
            <td><input name="disease" value="${item.disease}"></td>
            <td><input name="drug" value="${item.drug}"></td>
            <td><input type="number"  name="cost" value="${item.cost}" step=0.01 min =0></td>   
        </tr>
    </c:forEach>
    </c:if>
    </tbody>
...
<br></br>
<input type="submit" value="Response To Patient">
</form>
</c:if>
</div>
<br></br>
