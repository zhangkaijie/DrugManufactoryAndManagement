...
<div class="container marketing">
    <div align="center">
       <header> <h1>The Patient Work Area </h1></header>
    </div>
    <br></br>
  <!-- Three columns of text below the carousel -->
  <div class="row">
     <div class="col-md-4 text-center">
      <img class="img-circle" src="https://d16klsh1z1xre7.cloudfront.net/dorp/dorp/0/1e39/5804/1006059920-size-exact-140x140.jpg">
      <h2><a href="viewHistory.htm">View History Record</a></h2>
      
    </div>
    <div class="col-md-4 text-center">
      <img class="img-circle" src="http://www.ptca.org/images/ryan_patient_140sq.jpg">
      <h2><a href="connectDoctor.htm">Send New Request To Doctor</a></h2>
         
    </div>
    <div class="col-md-4 text-center">
      <img class="img-circle" src="https://www.parking.uci.edu/distribution/images/icon_billing.jpg">
      <h2><a href="viewBilling.htm">View My Billing</a></h2>
    </div>   
  </div><!-- /.row -->
