...
<div align="center">
<h1 align="center">Personal Health Information</h1>
<c:if test="${empty list}"><h2>Sorry,you do not have any health information </h2>
<br>
...
<table border>
    ...
    <c:forEach var="item" items="${list}" varStatus="i">
        <tr>
            <td><input value="${item.diseaseDescription}"></td>
            <td><input value="${item.status}"></td>
            <td><input value="${item.disease}"></td>
            <td><input value="${item.drug}"></td>
            <td><input value="${item.cost}"></td>   
        </tr>
    </c:forEach>
    </c:if>
    </tbody>
