...
<div class="container marketing">
    <div align="center">
       <header> <h1>The CompoundManufactor Work Area </h1></header>
       
    </div>
  <!-- Three columns of text below the carousel -->
  <div class="row" align="center">
     <div class="col-md-4 text-center" >
   <img class="img-circle" src="http://4pics1wordanswers.info/pics/_1523_4.jpg">
      <h2><a href="message.htm">View New Messages</a></h2>
   ...
   <div class="col-md-4 text-center" >
    ...
    <div class="col-md-4 text-center" >
     <img class="img-circle" src="http://4pics1wordanswers.info/pics/_1523_3.jpg">
      <h2><a href="messageHistory.htm">View Message History</a></h2>
