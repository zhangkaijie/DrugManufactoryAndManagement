...
<div align="center">
<h1>Please Describe Your Disease </h1>
<form:form action="connectDoctor.htm" commandName="patientDoctorInteraction"
    method="post">
 ...
 <table>
      ...
      <tr style="height:50px">
        ...
        <td><form:input name="diseaseDescription" path="diseaseDescription" size="30" placeholder="Disease Description" style="height:30px; border-radius:5px" required="required" />
          <font color="red"><form:errors path="diseaseDescription" /></font></td>
      </tr>
            
      <tr style="height:50px">
        <td id="td" colspan="2"><input id="submit" type="submit" value="Send To Doctor" /></td>
      </tr>
    </table>
