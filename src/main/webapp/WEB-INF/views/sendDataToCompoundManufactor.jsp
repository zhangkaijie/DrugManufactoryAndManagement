...
<div align="center">
<h1>Input Message</h1>
<form:form action="connectCompoundManufactor.htm" commandName="compoundDrugInteraction"
    method="post">
 ...
 <table>
      ...
      <tr style="height:50px">
        ...
        <td><form:input name="compound" path="compound" size="30" placeholder="Compound" style="height:30px; border-radius:5px" required="required" />
          <font color="red"><form:errors path="compound" /></font></td>
      </tr>
       
      <tr style="height:50px">
        
        <td><form:input name="message" path="message" size="30" placeholder="Message" style="height:30px; border-radius:5px" required="required" />
          <font color="red"><form:errors path="message" /></font></td>
      </tr>
            
      <tr style="height:50px">
        <td id="td" colspan="2"><input id="submit" type="submit" value="Send To CompoundManufactor" /></td>
      </tr>
    </table>
