...
<head>
  ...
  <script src="http://cdn.static.runoob.com/libs/bootstrap/3.3.7/js/bootstrap.min.js"></script>  
    <script src="<c:url value="/resources/js/echarts.simple.min.js"/>"></script>
...
<script type="text/javascript">
		var names = '${names}';
		var values = '${values}';
		var nameArr = names.replace("[","").replace("]","").split(",");
		var valueArr = values.replace("[","").replace("]","").split(",");
